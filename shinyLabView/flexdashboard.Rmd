...
chkSlowBleed <- reactive({
  ...
  dataVector <- dataVector[1:(length(dataVector)-2)] # remove norm values from dataVector 
  ...
  if (max(dataVector) > 3*min(dataVector) && which.max(dataVector) != length(dataVector)-2) { # exclude drop
    return(HTML(paste(
        ...
        '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>',
          ...
          'This patient experienced a 3-fold rise in Creatinine. <strong>This is a sign of acute kidney injury.</strong>',
        '</div>',
        sep = ""
      )))
  }
    ...
    if (max(dataVector) > 4 && (dataVector[i]-dataVector[i+1] > 0.5 || dataVector[i]-dataVector[i+2] > 0.5)) { 
      ...
      return(HTML(paste(
          '<div class="alert alert-warning alert-dismissible" role="alert">',
            ...
            '</strong> and <strong>',
            names(data[i]),
            '</strong> over 4 mg/dl.   <strong>This is a sign of acute kidney injury.</strong>',
          '</div>',
        sep = ""
      )))
  }
  ...
  if (min(dataVector) < 0.25*max(dataVector) && which.min(dataVector) != length(dataVector)-2) { # exclude rise
    return(HTML(paste(
        ...
        '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>',
          ...
          'This patient experienced a >75% drop in Glomerular Filtration Rate. <strong>This is a sign of kidney injury.</strong>',
        '</div>',
        sep = ""
      )))
  }
...
chkHITprob <- reactive({
  ...
  if(HITscore == 1) {
    return(HTML(paste(
        ...
        '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>',
          ...
          'Heparin-induced thrombocytopenia (HIT)-probability: <strong>Moderate</strong>.',
        '</div>',
        sep = ""
      )))
  }
  ...
  if(HITscore == 2) {
    return(HTML(paste(
        ...
        '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>',
          '<strong>Warning - Patient\'s platelet levels dropped!</strong><br>',
          'Heparin-induced thrombocytopenia (HIT)-probability: <strong>High</strong>.',
        '</div>',
        sep = ""
      )))
  }
