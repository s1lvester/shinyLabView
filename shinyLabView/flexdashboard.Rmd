...
-----------------------------------------------------------------------
```{r}
labData$date <- as_datetime(labData$date, origin = lubridate::origin, tz = "UTC") # convert int to unixTs-obj.
labData$date <- format(labData$date, format = "%Y-%m-%d, %H:%M") # convert unixTs to human readable string
